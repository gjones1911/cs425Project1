...
# no longer in use
def get_avg_best_w(best_train_w, best_val_w, tr_l, y_tr_l, val_l, y_val_l):
...
def get_avg_best_w_lse(best_train_w, best_val_w, tr_l, y_tr_l, val_l, y_val_l):
...
def get_avg_best_w_mse(best_train_w, best_val_w, tr_l, y_tr_l, val_l, y_val_l):
